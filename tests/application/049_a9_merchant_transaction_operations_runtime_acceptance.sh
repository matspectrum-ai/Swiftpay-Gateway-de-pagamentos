...
: "${SWIFTPAY_DASHBOARD_CURSOR_ACTIVE_KEY_ID:?SWIFTPAY_DASHBOARD_CURSOR_ACTIVE_KEY_ID is required}"
: "${SWIFTPAY_DASHBOARD_CURSOR_HMAC_KEYS:?SWIFTPAY_DASHBOARD_CURSOR_HMAC_KEYS is required}"
