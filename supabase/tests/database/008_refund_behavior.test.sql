...
insert into app.payments (id,merchant_id,environment,source,collection_status,amount_cents,currency,pricing_version,rounding_policy_version,merchant_fee_cents,merchant_net_cents,refunded_amount_cents,paid_at)
values ('00000000-0000-0000-0000-000000008100','00000000-0000-0000-0000-000000008001','sandbox','api','paid',10000,'BRL','test-v1','test-v1',1000,9000,0,now());
